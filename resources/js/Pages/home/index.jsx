    ...
    const hapusPosting = async (postId) => {
        try {
            ...
            if (response.ok) {
                ...
                setLoadedPostings((prevPostings) => prevPostings.filter((post) => post.id !== postId));
        ...
        <div className="bg-cyan-900 text-white">
            ...
            <div>
                ...
                <div className="card-container" style={{ width: "100%" }}>
                    {loadedPostings &&
                    Array.isArray(loadedPostings) &&
                    loadedPostings.length > 0 ? (
                        loadedPostings
...
>
  Hapus
                                    ...
                                    <div>
                                        ...
                                        >
                                            {post.showComments ? "Sembunyikan Komentar" : "Tampilkan Komentar"}
                                        </button>
                                    </div>
                                    {auth.user && <div></div>}
                                </div>
